...
<template>
  ...
  <div class="wallet-carousel-container" style="padding:0; margin:0; max-width:100vw; width:100vw;">
    ...
    >
      <template #asof>
        <span style="background: none; padding: 0; font-size: 0.82rem; font-weight: 400; color: #e0e0e0;">
    ...
    <q-btn
      ...
      size="sm"
      style="margin-bottom: 8px; margin-top: -110px;margin-left: 350px;"
      @click="onCashIn"
    />
    <QuickActions :actions="quickActions" @action="onQuickAction" />

  <BannerImage src="/banner/banner-grow.jpg" alt="Banner" imgStyle="max-width: 400px; border-radius: 12px; box-shadow: 0 2px 8px #0002; margin-top: -20px; margin-bottom: -20px;" />
...
function onCashIn() {
  // handle cash in click
}

const quickActions = [
  { icon: 'account_balance_wallet', label: 'GFunds' },
  { icon: 'candlestick_chart', label: 'GStocks PH' },
  { icon: 'generating_tokens', label: 'GCrypto' },
  { icon: 'gavel', label: 'GBonds' }
]
